...
sys.path.append('/home/local/custom_mqtt_client')
...
def setup():
    ...
    print("Setting up photo-taking services...")
    # Start only what you need
    mqtt_service.setup()  # No on_mqtt_message needed if not decoding any MQTT data
    print("MQTT service setup complete.")
    #gpio.setup()
    #print("GPIO service setup complete.")
    data_logger_service.setup()
    print("Data logger service setup complete.")
